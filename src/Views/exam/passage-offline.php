...
function content_init()
{
    ...
    <div class="slider-item">
        ...
        <p class="slider-text">
            Bonjour, <b><?= $candidat->NOM ?> <?= $candidat->PRENOM ?></b> votre exam <b><?= $cour->NOM_COUR ?></b>
            maintenant n'est pas
            disponible, <b class="text-success">le passage de cette exam il va faire en hors ligne</b>
        </p>
        <nav>
