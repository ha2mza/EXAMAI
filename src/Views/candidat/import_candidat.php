            ...
            <div class="modal-body">
                ...
                <form id="ImportCandidatForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <label for="import-candidat-class"><?= trans('candidat.class') ?></label>
                            <select id="import-candidat-class" class="form-control" name="ID_CLASSE"></select>
                        </div>
                    </div>
...
function import_candidat_script_init()
{
    ...
    <script>
        ...
        $('#ImportCandidatDialog').on('show.bs.modal', function () {
        ...
        function verifyImportCandidat() {
            ...
            data.append('ID_CLASSE', $("#import-candidat-class").val());
